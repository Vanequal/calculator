...
import { toggleAuthModal, setUser, setAwaitingConfirmation } from '../store/slices/authSlice';
    ...
    return (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 px-4">
            <div className="bg-white border border-black rounded-xl w-full max-w-sm p-6">
                ...
                <button onClick={handleClose} className="mt-4 text-sm text-gray-500 underline w-full text-center">
                    Закрыть
                </button>
            </div>
        </div>
